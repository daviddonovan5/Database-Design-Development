...
, system_user_name            VARCHAR2(20) CONSTRAINT nn_system_lab_user_1 NOT NULL
...
INSERT INTO common_lookup_lab VALUES
( common_lookup_lab_s1.nextval,'ITEM','BLU-RAY','Blu-ray', 1, SYSDATE, 1, SYSDATE);
...
BEGIN
  ...
  END LOOP;
  FOR i IN (SELECT null FROM user_sequences WHERE sequence_name = 'STREET_ADDRESS_S1_LAB') LOOP
